...
class ImageEmbedding(nn.Module):
    def __init__(self, hidden_size, use_gpu, feature_type='VGG'):
        ...
        # vgg16: linear = 512 -> 1024 #
        # res152: linear = 2048 -> 1024 #
    ...
    def forward(self, input_image):
        ...
        # vgg: batch_size * 14 * 14 * 512 -> batch_size * 196 * 512
        # res152: batch_size * 14 * 14 * 2048 -> batch_size * 196 * 2048
        input_image = input_image.view(batch_size, -1,self.img_features)
        
        # vgg: batch_size * 196* 512 -> batch_size * 196 * 1024
        # res152: batch_size * 14 * 14 * 2048 -> batch_size * 196 * 1024
